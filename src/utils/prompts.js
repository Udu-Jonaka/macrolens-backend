...
const analyzeTextPrompt = `
You are an expert AI nutritionist. Analyze the following text describing a meal.
If the user does not specify portion sizes, estimate standard average servings. Identify the ingredients and calculate the nutritional information.
...
module.exports = { analyzeMealPrompt, analyzeTextPrompt };
